# PR: Chronicle-Core#361 (VALID_FEATURE)

**Track C — Feature/docs PR**  ·  priority tier 6  ·  base `ea`  ·  branch `feat/Chronicle-Core-361-api-decision-implement-constructor`
Issue: https://github.com/OpenHFT/Chronicle-Core/issues/361

## Planned change
API decision: implement constructor-configured WeakThreadLocal + deprecate getTL, or close insufficient-value; document capturing-lambda concern.

## Quality bar (must clear before this PR merges)
- One issue, one PR; link with `Fixes #361`; scope limited to this issue.
