...
Chronicle Core class `Jvm` loads the file `system.properties` into the System's properties. To ensure it is loaded early enough, add the following code to your Main
