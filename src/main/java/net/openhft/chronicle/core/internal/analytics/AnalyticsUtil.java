...
/*
    ...
    private static final Map<String, Map<String, AnalyticsFacade>> INSTANCES = new ConcurrentHashMap<>();

    @NotNull
    public static AnalyticsFacade acquire(@NotNull final String libraryName, @NotNull final String libraryVersion) {
