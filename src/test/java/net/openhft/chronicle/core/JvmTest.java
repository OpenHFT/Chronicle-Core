...
class JvmTest extends CoreTestCommon {
    ...
    void addToClassPath() {
        ...
        if (JvmTest.class.getClassLoader() instanceof URLClassLoader) {
            ...
            assertSame(propertyBefore, propertyAfter, "class path property should remain unchanged for non-URLClassLoader");
        }
    }
    ...
    void testRethrow() {
        assertThrows(ConfigurationException.class,
                ...
                "rethrow should propagate ConfigurationException");
    }

    @Test
    void shouldGetMajorVersion() {
        int majorVersion = Jvm.majorVersion();
        assertTrue(majorVersion > 0, "JVM major version " + majorVersion + " should be > 0");
    }
    ...
    void testGetValue() {
        ...
        assertEquals(Jvm.address(bb), address, "retrieved address via reflection should match Jvm.address()");
    ...
    void testMaxDirectMemory() {
        ...
        assertTrue(maxDirectMemory > 0, "maximum direct memory " + maxDirectMemory + " should be > 0");
    }
    ...
    void classMetrics() throws IllegalArgumentException {
        ...
        assertThrows(IllegalArgumentException.class, () -> Jvm.classMetrics(ClassD.class),
                "classMetrics should reject unsupported class");
    }
    ...
    void address() {
        ...
        assertThrows(Exception.class, () -> Jvm.address(ByteBuffer.allocate(64)),
                "address should reject heap buffer");
    }
    ...
    void testGetMethod() {
        ...
        assertThrows(Throwable.class,
                ...
                "getMethod should reject default interface method");
    }
    ...
    void testCompileThreshold() {
        ...
        assertTrue(threshold > 0, "JIT compile threshold " + threshold + " should be > 0");
    }
    ...
    void testGetProcessId() {
        ...
        assertTrue(processId > 0, "process ID " + processId + " should be > 0");
    }
    ...
    void testUsedNativeMemory() {
        ...
        assertTrue(memory >= 0, "used native memory " + memory + " should be >= 0");
    }
    ...
    void testCommonInterruptible() {
        ...
        assertNotNull(commonInterruptible, "interruptible instance survives interrupt");
    }
