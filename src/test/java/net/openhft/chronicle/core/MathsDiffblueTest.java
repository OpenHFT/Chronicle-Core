...
public class MathsDiffblueTest {
  ...
  public void testRoundN() {
    ...
    assertThrows(IllegalArgumentException.class, () -> Maths.roundN(10.0d, 9.223372036854776E18d));
    assertEquals(10.0d, Maths.roundN(10.0d, -0.5d), 0.0);
  }
  ...
  public void testRoundingFactor() {
    ...
    assertThrows(IllegalArgumentException.class, () -> Maths.roundingFactor(98.3d));
  }
  ...
  public void testCeilN() {
    ...
    assertThrows(IllegalArgumentException.class, () -> Maths.ceilN(10.0d, 4.503599627370496E15d));
  ...
  public void testFloorN() {
    ...
    assertThrows(IllegalArgumentException.class, () -> Maths.floorN(10.0d, 4.503599627370496E15d));
