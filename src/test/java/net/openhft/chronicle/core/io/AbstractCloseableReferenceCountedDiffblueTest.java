...
public class AbstractCloseableReferenceCountedDiffblueTest extends CoreTestCommon {
  ...
  public void testReserve4() throws IllegalStateException {
    ...
    // Act
    myCloseableReferenceCounted.reserve(new AbstractReferenceCountedTest.MyReferenceCounted());
  ...
  public void testReserve7() throws IllegalStateException {
    ...
    // Act
    myCloseableReferenceCounted.reserve(new VanillaReferenceOwner(" closed="));
  ...
  public void testTryReserve4() throws IllegalArgumentException, IllegalStateException {
    ...
    // Act and Assert
    assertTrue(myCloseableReferenceCounted.tryReserve(new AbstractReferenceCountedTest.MyReferenceCounted()));
    assertFalse(myCloseableReferenceCounted.isClosing());
  }
