...
final class BackgroundResourceReleaserSupport {
    ...
    static void verifyExpectedCounts(int count, AtomicLong closed, AtomicLong released) {
    ...
    static void exerciseCloseableAndReferenceCounted(AtomicLong closed, AtomicLong released, boolean expectClosed) {
        ...
        assertEquals(expectClosed, bgc.isClosed(), "closeable should report closed state");
