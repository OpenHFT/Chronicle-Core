...
class ExceptionKeyTest extends CoreTestCommon {
    ...
    void testEqualsAndHashCode() {
        ...
        assertEquals("ExceptionKey{level=WARN, clazz=class net.openhft.chronicle.core.onoes.ExceptionKeyTest, message='two', throwable=}", ek2.toString(), "WARN ExceptionKey toString should include level, class, message and throwable");
        assertNotEquals(ek1, ek2, "ExceptionKeys with different levels should not be equal");
        assertNotEquals(ek1.hashCode(), ek2.hashCode(), "ExceptionKeys with different levels should not share hashCode");
    }
}
