...
public class InterruptedRuntimeExceptionTest {
    ...
    public void testConstructorWithMessage() {
        String message = "Thread interrupted";
    ...
    public void testConstructorWithCause() {
        ...
        assertEquals("java.lang.InterruptedException: Interrupted", exception.getMessage());
        assertEquals(cause, exception.getCause());
    }

    @Test
    public void testPreserveInterruptStatus() {
        Thread.currentThread().interrupt();
        try {
            // This block emulates the usage scenario described in the Javadoc
            throw new InterruptedRuntimeException("Thread was interrupted");
        } catch (InterruptedRuntimeException e) {
            // Ensure that the interrupt status is still set
