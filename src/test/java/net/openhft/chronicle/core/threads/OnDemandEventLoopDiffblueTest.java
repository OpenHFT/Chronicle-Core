...
public class OnDemandEventLoopDiffblueTest extends CoreTestCommon {
  ...
  */
  ...
  public void testConstructor() {
    ...
    assertTrue(actualOnDemandEventLoop.isClosing());
    assertTrue(actualOnDemandEventLoop.isClosed());
  ...
  /**
   * Method under test: {@link OnDemandEventLoop#isClosed()}
   */
  @Test
  public void testIsClosed() {
    // Arrange, Act and Assert
    assertTrue((new OnDemandEventLoop(mock(Supplier.class))).isClosed());
  }
