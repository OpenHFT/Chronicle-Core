...
public class LongTimeTest {
    ...
    public void millis() {
        ...
        assertEquals(epoch, LongTime.toMillis(LongTime.toSecs(epoch)));
    ...
    public void micros() {
        ...
        assertEquals(epoch, LongTime.toMicros(LongTime.toSecs(epoch)));
        assertEquals(epoch, LongTime.toMicros(LongTime.toMillis(epoch)));
    ...
    public void nanos() {
        ...
        assertEquals(epoch, LongTime.toNanos(LongTime.toSecs(epoch)));
        assertEquals(epoch, LongTime.toNanos(LongTime.toMillis(epoch)));
        assertEquals(epoch, LongTime.toNanos(LongTime.toMicros(epoch)));
