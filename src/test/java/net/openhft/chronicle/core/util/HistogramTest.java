...
class HistogramTest extends CoreTestCommon {
    ...
    void sampleCorrectlyUpdatesHistogram() {
        ...
        assertTrue(bucket >= 0, "bucket index should be non-negative for sampled value, was " + bucket);
        String formatted = histogram.toMicrosFormat();
        assertTrue(formatted.contains("worst"), formatted + " should contain worst-case value after sampling");
    }
    ...
    void addCombinesHistogramsCorrectly() {
        ...
        h2.sample(10);
        h1.add(h2);
        String formatted = h1.toMicrosFormat();
        assertTrue(formatted.contains("worst"), formatted + " should contain worst-case value after adding");
    }
    ...
    void percentilesForReturnsCorrectValues() {
        ...
        assertTrue(percentiles.length > 0, "percentiles array should contain at least one element, length was " + percentiles.length);
    }
